class ResponsesController < ApplicationController
  ...
  private
    ...
    def response_params
      params.require(:response).permit(:resolution_key, :res_description, :r_scale, :feedback, :acceptance_state, :response_date, :requesting_user_id, :executive_id, :ticket_id)
    end
end
