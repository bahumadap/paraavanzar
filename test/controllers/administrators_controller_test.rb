...
class AdministratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrator" do
    assert_difference("Administrator.count") do
      post administrators_url, params: { administrator: { administrator_email: @administrator.administrator_email, user_id: @administrator.user_id } }
    end
  ...
  test "should update administrator" do
    patch administrator_url(@administrator), params: { administrator: { administrator_email: @administrator.administrator_email, user_id: @administrator.user_id } }
