...
class SupervisorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supervisor" do
    assert_difference("Supervisor.count") do
      post supervisors_url, params: { supervisor: { supervisor_email: @supervisor.supervisor_email, user_id: @supervisor.user_id } }
    end
  ...
  test "should update supervisor" do
    patch supervisor_url(@supervisor), params: { supervisor: { supervisor_email: @supervisor.supervisor_email, user_id: @supervisor.user_id } }
